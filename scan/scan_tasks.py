...
class PFCTasks:
    ...
    def complex_decision_making_task(self, topic, context=""):
    ...
    def emotional_risk_assessment_task(self, topic, context=""):
        description = dedent(f"""
    ...
    def reward_evaluation_task(self, topic, context=""):
        description = dedent(f"""
    ...
    def conflict_resolution_task(self, topic, context=""):
        description = dedent(f"""
    ...
    def social_cognition_task(self, topic, context=""):
        description = dedent(f"""
