...
class CustomCrew:
    ...
    def get_task_outputs(self, crew: Crew) -> dict:
    ...
    def combine_outputs(self, task_outputs: dict) -> str:
        """Combine outputs from all tasks into a final report."""
        sections = [
            ("Decision-making analysis (DLPFC)", task_outputs.get("complex_decision_making_task", "")),
